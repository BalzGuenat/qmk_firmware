...
#define MANUFACTURER Balz Guenat
#define PRODUCT      BreakUp60
 ...
 *
 */
#define MATRIX_ROW_PINS { D4, F1, B0, F5, F6 }
#define MATRIX_COL_PINS { D3, C7, C6, B5, B4, D7, D6, NO_PIN }
