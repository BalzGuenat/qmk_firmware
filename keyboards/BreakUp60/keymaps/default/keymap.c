...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LSFT, _______, KC_Z,    KC_X, KC_C,   KC_V,  KC_B,   KC_N, KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_ENT,
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, BL_STEP, BL_BRTG, RGB_HUI, RGB_MOD,RGB_TOG, LCTL(KC_BSPC), LCTL(KC_DEL),  _______, _______, _______, _______, KC_MPLY,
