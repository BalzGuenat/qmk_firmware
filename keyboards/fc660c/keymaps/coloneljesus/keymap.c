...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
        ...
        MO(1),  KC_MUTE,KC_VOLD,KC_MPLY,KC_PGDN,KC_DEL, KC_LEFT,KC_DOWN,      KC_UP,        KC_RGHT,_______,_______,     _______,
  ...
  [2] = LAYOUT(
        ...
        _______,_______,_______,                _______,                _______,KC_APP,MO(2),       _______,_______,_______
    )
};
