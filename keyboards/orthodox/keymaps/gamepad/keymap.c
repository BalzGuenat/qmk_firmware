...
[_QWERTY] = KEYMAP( \
  KC_ESC,  KC_5,    KC_1, KC_2, KC_3, KC_4,                                                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
  KC_TAB,  KC_4,    KC_Q, KC_W, KC_E, KC_R, KC_T,   XXXXXXX, KC_G,             KC_UP,   XXXXXXX, KC_RGHT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LCTL, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_SPC, KC_LCTL, KC_TAB,           KC_RALT, LS__SPC, RAISE,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LGUI \
),
...
[_RAISE] = KEYMAP( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, _______,          _______, _______, _______, KC_F12,  KC_PGUP, KC_COMM, KC_DOT,  KC_PGDN, RESET    \
),
